        ...
        implements Map<K,V>
{
    ...
    Node<K,V> newNode(int hash, K key, V value, Node<K,V> e) {
        MyLinkedHashMap.Entry<K,V> p =
                new MyLinkedHashMap.Entry<>(hash, key, value, e);
        linkNodeLast(p);
        return p;
    }
    ...
    Node<K,V> replacementNode(Node<K,V> p, Node<K,V> next) {
        ...
        MyLinkedHashMap.Entry<K,V> t =
                new MyLinkedHashMap.Entry<>(q.hash, q.key, q.value, next);
        transferLinks(q, t);
        return t;
    }
    ...
    public Set<K> keySet() {
        Set<K> ks = keySet;
        if (ks == null) {
            ks = new MyLinkedHashMap.LinkedKeySet();
            keySet = ks;
        }
        return ks;
    }
    ...
    public Collection<V> values() {
        ...
        if (vs == null) {
            vs = new MyLinkedHashMap.LinkedValues();
            values = vs;
        }
        return vs;
    }
