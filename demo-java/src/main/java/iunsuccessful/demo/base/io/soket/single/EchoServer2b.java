...
/**
 * 允许中断链接
 * This server improves on the previous Echo Server since it allows the "connection thread" of the
 * server to stop executing via a command sent from the client.
 */
