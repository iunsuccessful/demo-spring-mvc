...
//        throw new DecoderException("type is not an instance of Class or ParameterizedType: " + type);
        throw new feign.codec.DecodeException(400, "type is not an instance of Class or ParameterizedType: " + type, null);
    }
